...
Dim log As New EventLog("MyApplication", "Microsoft Dev", "Azure 2")
log.WriteEntry("acs-engine Exploration Extension for Microsoft Azure CLI 2.0", EventLogEntryType.Warning, 502)
